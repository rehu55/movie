...
API_ID = int(environ.get('API_ID', '36580807')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'bacd1587a598324319643c79d2138c94')  # API Hash from my.telegram.org
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/qxf1zk.jpg'))
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5286535671 5685076977').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003837284937').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003718832507'))  # Log channel id (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003628492256')  # Request channel id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/qxf1zk.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '99135665@ibl')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Dark7777:Dark7777@cluster0.q3ypjzz.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Dark7777") # Database name (default: cluster)
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003718832507')) #Verification Channel Id 
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/newmowthor/111")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/newmowthor/111")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/newmowthor/111")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "8e4861d00c8c076921071db4b95ad3bba0d935e9") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "vplink.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "8e4861d00c8c076921071db4b95ad3bba0d935e9")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "vplink.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "8e4861d00c8c076921071db4b95ad3bba0d935e9")  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/All_movie_linkpp') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', '') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/newmowthor') # Update channel link for the bot
